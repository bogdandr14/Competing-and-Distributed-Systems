...
public class Demon extends Thread{
	...
	public int covenId;
	public SemaphoresCyclicBarrier barrier;

	Demon(Position position, int covenSize, HashMap<String, Demon> demonMapPosition, IPotionQueue potionQueue, int covenId, SemaphoresCyclicBarrier barrier){
